...
#
#    FIX 10 (v9): Added max radial expansion cap for maxCF mode.
#                 Without an upper bound, -force drives unbounded outward
#                 growth and Adam's per-parameter momentum breaks symmetry.
#                 New: r_max = max_expansion_ratio × r₀ (default 1.5).
#
...
def compute_loss(mode, inward_sec, force_total, perimeter, model,
    ...
    max_expansion_ratio : float
        (maxCF only) Maximum allowed r / r_initial ratio. Nodes that
        exceed this are penalised quadratically. Default 1.5 (50% growth).
    ...
    if mode == 'maxCF':
        ...
        # FIX 10 (v9): cap outward expansion to max_expansion_ratio × r₀
        # Without this, -force drives unbounded growth and Adam breaks symmetry
...
dataFileName = 'partition_data_dshape.mat'
