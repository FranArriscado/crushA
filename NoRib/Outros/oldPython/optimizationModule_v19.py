...
# 'maxCF'    -- caps outward radial growth
# 'maxSEA'   -- is used for both inward and outward radial bounds
# Regardless of the mode, this ratio should be viewed as  design constraint, more expansion space will find more/better solution
