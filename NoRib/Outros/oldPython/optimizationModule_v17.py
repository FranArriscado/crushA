...
#==========================================================================
thickness = 2                       # [mm]
dataFileName = 'partition_data.mat'
...
box_width  = 30                  # [mm] box extent in X
box_height = 30                  # [mm] box extent in Y
...
# ---- Rename output files to reflect actual epoch count ---- #
actual_epochs = final_epoch + 1
if actual_epochs >= 1000:
    _epoch_str = f'{actual_epochs // 1000}k' if actual_epochs % 1000 == 0 \
        else f'{actual_epochs / 1000:.1f}k'
else:
    _epoch_str = str(actual_epochs)
_final_base = f"{_shape}_{run_mode}_{_epoch_str}_{run_timestamp}_(v{script_version})"
