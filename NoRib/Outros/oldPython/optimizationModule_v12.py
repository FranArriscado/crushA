...
def compute_loss(mode, force_total, perimeter, model,
                 force_initial, perimeter_initial, smoothness_initial,
    ...
    smoothness_initial : Tensor
        Smoothness at epoch 0, used to normalise the penalty so that λ
        is geometry-independent. At epoch 0, smooth/smooth₀ = 1.0.
    lambdas : dict
    ...
    # Normalise: at epoch 0 this equals 1.0, making λ geometry-independent
...
with torch.no_grad():
        ...
        print('Smoothness initial:', smoothness_initial)
